...
class ProjectileTest {
    ...
    void testResetClearsHitFlag() {
        ...
        // Whether hit or not, reset should clear it
        proj.reset();
    ...
    // At angle 15°, P1 reaches P2's box at ~t=30 frames (verified analytically)
    @Test
    ...
    // At angle 3° (minimum), projectile stays too low, falls below box before x reaches opponent
    @Test
